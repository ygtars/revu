                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Revu Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Revu address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and revu: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Revu Core"), this);
    aboutAction->setStatusTip(tr("Show information about Revu Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Revu"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Revu addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Revu addresses"));
    ...
    openAction->setStatusTip(tr("Open a Revu: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Revu Core help message to get a list with possible Revu command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Revu Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Revu network", "", count));
}
...
{
    QString strTitle = tr("Revu Core"); // default title
...
/** Creates context menu, its actions, and revus up all the relevant signals for mouse events. */
