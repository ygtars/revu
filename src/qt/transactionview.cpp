                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Revu from zREVU"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zREVU"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zREVU));
