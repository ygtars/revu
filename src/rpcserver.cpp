...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Revu features */
        {"revu", "masternode", &masternode, true, true, false},
        {"revu", "listmasternodes", &listmasternodes, true, true, false},
        {"revu", "getmasternodecount", &getmasternodecount, true, true, false},
        {"revu", "masternodeconnect", &masternodeconnect, true, true, false},
        {"revu", "masternodecurrent", &masternodecurrent, true, true, false},
        {"revu", "masternodedebug", &masternodedebug, true, true, false},
        {"revu", "startmasternode", &startmasternode, true, true, false},
        {"revu", "createmasternodekey", &createmasternodekey, true, true, false},
        {"revu", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"revu", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"revu", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"revu", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"revu", "getmasternodescores", &getmasternodescores, true, true, false},
        {"revu", "mnbudget", &mnbudget, true, true, false},
        {"revu", "preparebudget", &preparebudget, true, true, false},
        {"revu", "submitbudget", &submitbudget, true, true, false},
        {"revu", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"revu", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"revu", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"revu", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"revu", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"revu", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"revu", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"revu", "checkbudgets", &checkbudgets, true, true, false},
        {"revu", "mnsync", &mnsync, true, true, false},
        {"revu", "spork", &spork, true, true, false},
        {"revu", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"revu", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use revud, or the -server option to revu-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> revu-cli " + methodname + " " + args + "\n";
}
