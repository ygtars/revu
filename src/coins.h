...
/** 
    ...
    ****Note - for Revu we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of revu coming in to a transaction
