Contributing to Revu Core
============================

The Revu Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Revu Core project, and is not to be
confused with overall Revu Network Protocol consensus changes.

Whether a pull request is merged into Revu Core rests with the project merge
...
Patches that change Revu consensus rules are considerably more involved than
...
Where a patch set proposes to change the Revu consensus, it must have been
...
The project leader is the release manager for each Revu Core release.
