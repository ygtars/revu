...
RESOURCES += src/qt/revu.qrc src/qt/revu_locale.qrc

TRANSLATIONS += src/qt/locale/revu_bg.ts \
                src/qt/locale/revu_de.ts \
                src/qt/locale/revu_en.ts \
                src/qt/locale/revu_es.ts \
                src/qt/locale/revu_fi.ts \
                src/qt/locale/revu_fr.ts \
                src/qt/locale/revu_it.ts \
                src/qt/locale/revu_ja.ts \
                src/qt/locale/revu_pl.ts \
                src/qt/locale/revu_pt.ts \
                src/qt/locale/revu_ru.ts \
                src/qt/locale/revu_sk.ts \
                src/qt/locale/revu_sv.ts \
                src/qt/locale/revu_vi.ts \
                src/qt/locale/revu_zh_CN.ts \
                src/qt/locale/revu_zh_TW.ts
